...
function run()
	while true do
		...
		local textx, texty = font_dimensions(font, 2.0, "Hello, I'm testing the sweet fonts. Do you like my sweet ass fonts?", 300)
		draw_rect(300, 430, textx, texty)
		set_color(1, 1, 1, 1)
		draw_font(font, 2.0, "Hello, I'm testing the sweet fonts. Do you like my sweet ass fonts?", 300, 430, 300)

		set_color(1, 1, 1, 1)
		draw_font(font, 2.0, "Hello, I'm testing the sweet fonts. Do you like my sweet ass fonts?", 300, 280, 300)
